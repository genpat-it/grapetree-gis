...
help_text['save_grapetree'] = '<h2>Loading in GrapeTree JSON</h2>\
<ul>\
<li><strong>Load GrapeTree</strong>: load a JSON file generated by this program which contains the tree data exactly as displayed and any metadata.</li>\
</ul>\
...
for (var k in help_text) {
    help_text[k] = help_text[k] + '<br>The complete documentation can be found in <a href="http://enterobase.readthedocs.io/en/latest/grapetree/grapetree-about.html" target="_blank">Online Documents</a>';
}
